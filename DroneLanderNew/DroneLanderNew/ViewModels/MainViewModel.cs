...
using DroneLanderNew.Common;
using DroneLanderNew.Data;
using DroneLanderNew.Models;
using Xamarin.Forms;

namespace DroneLanderNew.ViewModels
{
    public class MainViewModel : ObservableBase
    {
        ...
        private void UpdateFlightParameters()
        {
            ...
            double force = this.ActiveLandingParameters.Thrust - (avgmass * CoreConstants.Gravity);
